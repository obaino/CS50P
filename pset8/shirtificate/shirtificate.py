...
text = "Nikos Kyriazis took CS50"

img = Image.open("shirtificate.png")
myFont = ImageFont.truetype("Helvetica", size=24)
...
ImageDraw.Draw(new_img).text(((width - length) / 2, (height - 25) / 3), text, fill =(255, 255, 255),font=myFont)
